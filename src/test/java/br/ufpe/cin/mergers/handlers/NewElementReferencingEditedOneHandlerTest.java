...
public class NewElementReferencingEditedOneHandlerTest {
  ...
  public void testNereoFieldMethod() {
    ...
    assertTrue(
        mergeResult.contains("<<<<<<<MINEstaticintm(){return15;}=======inta=m();>>>>>>>YOURS"));
    assertTrue(ctx.newElementReferencingEditedOneConflicts == 1);
  }
  ...
  public void testNereoMethodMethod() {
    ...
    assertTrue(
        mergeResult.contains(
            "<<<<<<<MINEstaticStringm(){return\"insidemethodmedited\";}=======voidn(){if(m().equals(\"something...\")){System.out.println(\"insidemethodn\");}}>>>>>>>YOURS"));
    assertTrue(ctx.newElementReferencingEditedOneConflicts == 1);
  }
}
