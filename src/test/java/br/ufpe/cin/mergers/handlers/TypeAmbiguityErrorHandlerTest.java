...
public class TypeAmbiguityErrorHandlerTest {
  ...
  public void testImportMemberMember() {
    ...
    assertTrue(
        mergeResult.contains(
            "<<<<<<<MINEimportjava.awt.List;=======importjava.util.List;>>>>>>>YOURS"));
  ...
  public void testImportPackagePackage() {
    ...
    assertTrue(
        mergeResult.contains("<<<<<<<MINEimportpckt.*;=======importpcktright.*;>>>>>>>YOURS"));
    assertTrue(ctx.typeAmbiguityErrorsConflicts == 1);
  }
  ...
  public void testImportPackageMember() {
    ...
    assertTrue(
        mergeResult.contains("<<<<<<<MINEimportpckt.A;=======importpcktright.*;>>>>>>>YOURS"));
    assertTrue(ctx.typeAmbiguityErrorsConflicts == 1);
  }
}
