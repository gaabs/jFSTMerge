...
public class DeletionsHandlerTest {
  ...
  public void testInnerDeletionWithNewInstanceOfOriginal() {
    ...
    assertTrue(
        FilesManager.getStringContentIntoSingleLineNoSpacing(ctx.semistructuredOutput)
            .equals(
                "packagecom.example;publicclassTest{classA{doublea;doubleb;}classB{doublea;}publicstaticvoidmain(String[]args){newA();}}"));
    assertTrue(ctx.innerDeletionConflicts == 0);
  }
  ...
  public void testInnerDeletionWithNewInstanceOfRenamed() {
    ...
    assertTrue(
        FilesManager.getStringContentIntoSingleLineNoSpacing(ctx.semistructuredOutput)
            .equals(
                "packagecom.example;publicclassTest{<<<<<<<MINE=======classA{doublea;doubleb;}>>>>>>>YOURSclassB{doublea;}publicstaticvoidmain(String[]args){newB();}}"));
  ...
  public void testInnerDeletionWithNewInstanceOfOriginalReversed() {
    ...
    assertTrue(
        FilesManager.getStringContentIntoSingleLineNoSpacing(ctx.semistructuredOutput)
            .equals(
                "packagecom.example;publicclassTest{classA{doublea;doubleb;}publicstaticvoidmain(String[]args){newA();}classB{doublea;}}"));
    assertTrue(ctx.innerDeletionConflicts == 0);
  }
  ...
  public void testInnerDeletionWithNewInstanceOfRenamedReversed() {
    ...
    assertTrue(
        FilesManager.getStringContentIntoSingleLineNoSpacing(ctx.semistructuredOutput)
            .equals(
                "packagecom.example;publicclassTest{<<<<<<<MINEclassA{doublea;doubleb;}=======>>>>>>>YOURSclassB{doublea;}publicstaticvoidmain(String[]args){newB();}}"));
    assertTrue(ctx.innerDeletionConflicts == 1);
  }
