...
public class GeneratedParserTest {
  ...
  /**
   * @param args parserClass, mainProduction, targetFile
  ...
  public static void main(String[] args)
    ...
    if (!inputFile.exists()) throw new FileNotFoundException(targetFileName);
  ...
  public void test(String parserClassName, String mainProduction, String targetFileName)
      throws ClassNotFoundException, InstantiationException, IllegalAccessException,
          IllegalArgumentException, SecurityException, InvocationTargetException,
          NoSuchMethodException, FileNotFoundException, InterruptedException {
