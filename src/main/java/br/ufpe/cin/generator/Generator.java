...
/**
 * Class reponsible for dealing with the automatic generation of parsers trough <i>featureBNF</i>
 * grammars. See the text files in the folder <i>/documentation</i> for more details.
 *
 * @author Guilherme
 */
