...
/**
 * Class responsbile for dealing with language specific conflicts that just superimposition of trees
 * is not able to detect/resolve.
 *
 * @author Guilherme
 */
public final class ConflictsHandler {

  public static void handle(MergeContext context) throws TextualMergeException {
    context.semistructuredOutput =
        Prettyprinter.print(
            context
                .superImposedTree); // partial result of semistructured merge is necessary for
                                    // further processing
  ...
  private static void findAndDetectInitializationBlocks(MergeContext context)
