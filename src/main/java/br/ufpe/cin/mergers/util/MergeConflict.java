...
public class MergeConflict {
  ...
  public MergeConflict(
      String leftConflictingContent, String rightConflictingContent, int startLOC, int endLOC) {
    this.left = leftConflictingContent;
    this.right = rightConflictingContent;
    this.body =
        "<<<<<<< MINE\n"
  ...
  public MergeConflict(
      String leftConflictingContent, String rightConflictingContent, String message) {
    this.left = leftConflictingContent;
    this.right = rightConflictingContent;
    this.body =
        "<<<<<<< MINE\n"
