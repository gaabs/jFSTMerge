...
/**
 * A merge scenario represents the revisions involved in a three-way merge: first revision(left),
 * base revision, second revision(right). This class mainly encapsulates the tuples of matched files
...
public class MergeScenario {
  ...
  public MergeScenario(
      String revisionsFilePath,
      String leftId,
      String baseId,
      String rightId,
      List<FilesTuple> tuples) {
