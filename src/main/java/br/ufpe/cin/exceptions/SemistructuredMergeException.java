...
public class SemistructuredMergeException extends Exception {
  ...
  public SemistructuredMergeException(String message) {
    super("Unexpected error while performing semistructured merge:/n" + message);
  }
  ...
  private static String detailErrorMessage(String incomingMessage, MergeContext context) {
    ...
    messageBuilder.append(
        "\nLEFT FILE CONTENT:\n"
            + ((context.getLeft() != null)
                ? FilesManager.readFileContent(context.getLeft())
                : "<empty left>"));
    messageBuilder.append(
        "\nBASE FILE CONTENT:\n"
            + ((context.getBase() != null)
                ? FilesManager.readFileContent(context.getBase())
                : "<empty base>"));
    messageBuilder.append(
        "\nRIGHT FILE CONTENT:\n"
            + ((context.getRight() != null)
                ? FilesManager.readFileContent(context.getRight())
                : "<empty right>"));
