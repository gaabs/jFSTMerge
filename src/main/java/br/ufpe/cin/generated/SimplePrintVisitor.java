...
public class SimplePrintVisitor extends AbstractFSTPrintVisitor {
  ...
  protected boolean isSubtype(String type, String expectedType) {
    ...
    if (type.equals("ConditionalExpression1") && expectedType.equals("ConditionalExpression"))
      return true;
    if (type.equals("CastExpression3") && expectedType.equals("CastExpression")) return true;
    if (type.equals("BlockStatementInternal2") && expectedType.equals("BlockStatementInternal"))
      return true;
    if (type.equals("PrimaryPrefix15") && expectedType.equals("PrimaryPrefix")) return true;
    if (type.equals("StatementExpressionAssignment2")
        && expectedType.equals("StatementExpressionAssignment")) return true;
    if (type.equals("InnerEnumDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    ...
    if (type.equals("StatementExpression3") && expectedType.equals("StatementExpression"))
      return true;
    if (type.equals("ExplicitConstructorInvocation1")
        && expectedType.equals("ExplicitConstructorInvocation")) return true;
    if (type.equals("ConditionalExpression2") && expectedType.equals("ConditionalExpression"))
      return true;
    if (type.equals("BlockStatementInternal1") && expectedType.equals("BlockStatementInternal"))
      return true;
    if (type.equals("StatementExpressionAssignment3")
        && expectedType.equals("StatementExpressionAssignment")) return true;
    ...
    if (type.equals("StatementExpression2") && expectedType.equals("StatementExpression"))
      return true;
    if (type.equals("RelationalOp1") && expectedType.equals("RelationalOp")) return true;
    if (type.equals("AnnotationInnerFieldDecl")
        && expectedType.equals("AnnotationTypeMemberDeclaration")) return true;
    if (type.equals("UnaryOp2") && expectedType.equals("UnaryOp")) return true;
    if (type.equals("StatementExpression1") && expectedType.equals("StatementExpression"))
      return true;
    ...
    if (type.equals("StatementExpressionAssignment1")
        && expectedType.equals("StatementExpressionAssignment")) return true;
    ...
    if (type.equals("VariableInitializer1") && expectedType.equals("VariableInitializer"))
      return true;
    if (type.equals("AssignmentOperator2") && expectedType.equals("AssignmentOperator"))
      return true;
    if (type.equals("AnnotationInnerEnumDecl")
        && expectedType.equals("AnnotationTypeMemberDeclaration")) return true;
    ...
    if (type.equals("VariableInitializer2") && expectedType.equals("VariableInitializer"))
      return true;
    if (type.equals("UnaryExpression4") && expectedType.equals("UnaryExpression")) return true;
    if (type.equals("AssignmentOperator3") && expectedType.equals("AssignmentOperator"))
      return true;
    if (type.equals("UnaryOp1") && expectedType.equals("UnaryOp")) return true;
    if (type.equals("InnerAnnotationTypeDecl")
        && expectedType.equals("ClassOrInterfaceBodyDeclaration")) return true;
    ...
    if (type.equals("ExplicitConstructorInvocation2")
        && expectedType.equals("ExplicitConstructorInvocation")) return true;
    ...
    if (type.equals("MethodDeclarationBody1") && expectedType.equals("MethodDeclarationBody"))
      return true;
    ...
    if (type.equals("AnnoationEmptyDecl") && expectedType.equals("AnnotationTypeMemberDeclaration"))
      return true;
    ...
    if (type.equals("ExplicitConstructorInvocation3")
        && expectedType.equals("ExplicitConstructorInvocation")) return true;
    if (type.equals("MethodDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    if (type.equals("AssignmentOperator1") && expectedType.equals("AssignmentOperator"))
      return true;
    if (type.equals("AnnotationInnerTypeDecl")
        && expectedType.equals("AnnotationTypeMemberDeclaration")) return true;
    ...
    if (type.equals("AssignmentOperator12") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("AssignmentOperator7") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("MethodDeclarationBody2") && expectedType.equals("MethodDeclarationBody"))
      return true;
    if (type.equals("AssignmentOperator11") && expectedType.equals("AssignmentOperator"))
      return true;
    if (type.equals("Statement5") && expectedType.equals("Statement")) return true;
    if (type.equals("AllocationExpression2") && expectedType.equals("AllocationExpression"))
      return true;
    if (type.equals("AssignmentOperator8") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("AssignmentOperator4") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("ForStatementInternal2") && expectedType.equals("ForStatementInternal"))
      return true;
    if (type.equals("Modifier8") && expectedType.equals("Modifier")) return true;
    if (type.equals("AssignmentOperator10") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("CatchBlockInternal2") && expectedType.equals("CatchBlockInternal"))
      return true;
    ...
    if (type.equals("AssignmentOperator5") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("ForStatementInternal1") && expectedType.equals("ForStatementInternal"))
      return true;
    ...
    if (type.equals("AssignmentOperator6") && expectedType.equals("AssignmentOperator"))
      return true;
    if (type.equals("CastLOOK_AHEADOp4") && expectedType.equals("CastLOOK_AHEADOp")) return true;
    if (type.equals("AnnotationTypeMemberDeclaration1")
        && expectedType.equals("AnnotationTypeMemberDeclaration")) return true;
    if (type.equals("PrimitiveType4") && expectedType.equals("PrimitiveType")) return true;
    if (type.equals("CatchBlockInternal1") && expectedType.equals("CatchBlockInternal"))
      return true;
    ...
    if (type.equals("UnaryExpressionNotPlusMinus3")
        && expectedType.equals("UnaryExpressionNotPlusMinus")) return true;
    ...
    if (type.equals("ConstructorDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    ...
    if (type.equals("EmptyDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    if (type.equals("UnaryExpressionNotPlusMinus2")
        && expectedType.equals("UnaryExpressionNotPlusMinus")) return true;
    ...
    if (type.equals("FieldDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    ...
    if (type.equals("VariableDeclaratorId3") && expectedType.equals("VariableDeclaratorId"))
      return true;
    ...
    if (type.equals("UnaryExpressionNotPlusMinus1")
        && expectedType.equals("UnaryExpressionNotPlusMinus")) return true;
    ...
    if (type.equals("InitializerDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    ...
    if (type.equals("AllocationExpression1") && expectedType.equals("AllocationExpression"))
      return true;
    if (type.equals("AnnotationInnerClassDecl")
        && expectedType.equals("AnnotationTypeMemberDeclaration")) return true;
    if (type.equals("AssignmentOperator9") && expectedType.equals("AssignmentOperator"))
      return true;
    ...
    if (type.equals("AllocationExpressionInit2") && expectedType.equals("AllocationExpressionInit"))
      return true;
    if (type.equals("VariableDeclaratorId2") && expectedType.equals("VariableDeclaratorId"))
      return true;
    ...
    if (type.equals("BlockStatementInternal4") && expectedType.equals("BlockStatementInternal"))
      return true;
    ...
    if (type.equals("BlockStatementInternal3") && expectedType.equals("BlockStatementInternal"))
      return true;
    ...
    if (type.equals("InnerClassDecl") && expectedType.equals("ClassOrInterfaceBodyDeclaration"))
      return true;
    ...
    if (type.equals("AllocationExpressionInit1") && expectedType.equals("AllocationExpressionInit"))
      return true;
    if (type.equals("Literal5") && expectedType.equals("Literal")) return true;
    if (type.equals("VariableDeclaratorId1") && expectedType.equals("VariableDeclaratorId"))
      return true;
